...
mod tests {
    ...
    fn resize_to_with_screen_delta_consistency() {
        ...
        state.resize_to(ResizeParams {
            handle: ResizeHandle::BottomRight,
            start_mouse_x: 200.0,
            start_mouse_y: 200.0,
            current_mouse_x: 250.0,
            current_mouse_y: 230.0,
    ...
    fn resize_top_left_handle_keeps_bottom_right_corner_fixed() {
        ...
        state.resize_to(ResizeParams {
            ...
            start_mouse_x: 200.0,
            start_mouse_y: 200.0,
            current_mouse_x: 160.0,
            current_mouse_y: 175.0,
            original_width: 200.0,
            original_height: 150.0,
        });
    ...
    fn resize_bottom_left_handle_keeps_top_right_corner_fixed() {
        ...
        state.resize_to(ResizeParams {
            ...
            start_mouse_x: 200.0,
            start_mouse_y: 200.0,
            current_mouse_x: 165.0,
            current_mouse_y: 220.0,
            original_width: 200.0,
            original_height: 150.0,
        });
    ...
    fn resize_top_right_handle_keeps_bottom_left_corner_fixed() {
        ...
        state.resize_to(ResizeParams {
            ...
            start_mouse_x: 200.0,
            start_mouse_y: 200.0,
            current_mouse_x: 245.0,
            current_mouse_y: 185.0,
            original_width: 200.0,
            original_height: 150.0,
        });
    ...
    fn resize_bottom_right_handle_keeps_top_left_corner_fixed() {
        ...
        state.resize_to(ResizeParams {
            ...
            start_mouse_x: 200.0,
            start_mouse_y: 200.0,
            current_mouse_x: 255.0,
            current_mouse_y: 235.0,
            original_width: 200.0,
            original_height: 150.0,
        });
    ...
    fn resize_minimum_size_enforcement() {
        ...
        state.resize_to(ResizeParams {
            ...
            start_mouse_x: 200.0,
            start_mouse_y: 200.0,
            current_mouse_x: 400.0,
            current_mouse_y: 400.0,
            original_width: 200.0,
            original_height: 150.0,
        });
